        ...
        <div class="bg-card border border-border-subtle py-8 px-6 shadow-2xl rounded-3xl sm:px-10">
            ...
            @if ($errors->any())
                <div class="mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-sm">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <span class="font-bold">Correct the following errors:</span>
                    </div>
            ...
            <form action="{{ route('registracija.registruotis') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2 md:col-span-2">
                    <label for="vardas" class="block text-xs font-semibold text-muted-foreground uppercase tracking-wider pl-1">Name *</label>
                ...
                <!-- Email -->
                <div class="space-y-2 md:col-span-2">
                    <label for="e_pastas" class="block text-xs font-semibold text-muted-foreground uppercase tracking-wider pl-1">Email *</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-muted-foreground group-focus-within:text-primary transition-colors">
                ...
                <!-- Password -->
                <div class="space-y-2">
                    <label for="slaptazodis" class="block text-xs font-semibold text-muted-foreground uppercase tracking-wider pl-1">Password *</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-muted-foreground group-focus-within:text-primary transition-colors">
                ...
                <!-- Confirmation -->
                <div class="space-y-2">
                    <label for="slaptazodis_confirmation" class="block text-xs font-semibold text-muted-foreground uppercase tracking-wider pl-1">Confirm *</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-muted-foreground group-focus-within:text-primary transition-colors">
                ...
                <!-- Role -->
                <div class="space-y-2 md:col-span-2">
                    <label for="role" class="block text-xs font-semibold text-muted-foreground uppercase tracking-wider pl-1">Role *</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-muted-foreground group-focus-within:text-primary transition-colors">
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="1" class="bg-card" {{ old('role') == 1 ? 'selected' : '' }}>User</option>
                            <option value="2" class="bg-card" {{ old('role') == 2 ? 'selected' : '' }}>Administrator</option>
                        </select>
