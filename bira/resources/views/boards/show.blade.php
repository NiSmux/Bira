...
<div class="px-8 py-8">
    ...
    <div class="mt-8 border-t border-white/5 pt-8">
        ...
        <div class="kanban-tasks backlog-tasks w-full bg-white/[0.01] border border-dashed border-border-subtle rounded-3xl p-6 flex flex-col gap-3 min-h-[150px] transition-colors hover:bg-white/[0.02]" data-status-id="{{ $backlogStatus->id }}">
