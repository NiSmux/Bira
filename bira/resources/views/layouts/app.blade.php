    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-sidebar border-r border-border-subtle flex flex-col shrink-0">
            ...
            <nav class="flex-1 px-4 space-y-1 mt-4">
                ...
                <a href="{{ route('backlog.index') }}" class="sidebar-link flex items-center gap-3 px-3 py-2 rounded-lg text-muted-foreground hover:bg-white/5 hover:text-white transition-colors {{ request()->routeIs('backlog.*') ? 'active' : '' }}">
