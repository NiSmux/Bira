...
@section('title', 'Edit profile – Bira')
...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-10 flex items-center gap-6">
        ...
        <div>
            <h1 class="text-3xl font-extrabold tracking-tight text-white mb-1">Edit profile</h1>
    ...
    <div class="bg-card border border-border-subtle rounded-3xl overflow-hidden shadow-2xl">
        <form action="{{ route('profilis.atnaujinti') }}" method="POST" class="p-8 sm:p-10 space-y-8">
            ...
            <!-- Name Input -->
            <div class="space-y-2">
                <label for="name" class="block text-sm font-semibold text-muted-foreground uppercase tracking-wider">Name</label>
            ...
            <!-- Email Input -->
            <div class="space-y-2">
                <label for="email" class="block text-sm font-semibold text-muted-foreground uppercase tracking-wider">Email</label>
                <div class="relative group">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-muted-foreground group-focus-within:text-primary transition-colors">
